              ...
              <div class="w-full max-w-md">
                <div class="rounded-lg border border-gray-200 bg-white p-8">
                  <div class="mb-8 text-center">
                    <div class="mx-auto mb-6 flex h-32 w-80 items-center justify-center rounded-lg bg-white">
                      <img
                  ...
                  <div class="text-center">
                    ...
                    <div class="space-y-2 text-left">
                      <div class="flex items-center text-xs text-gray-600">
                        <span class="mr-2 flex h-4 w-4 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-600">
                          1
                        </span>
                      ...
                      <div class="flex items-center text-xs text-gray-600">
                        <span class="mr-2 flex h-4 w-4 items-center justify-center rounded-full bg-green-100 text-xs font-semibold text-green-600">
                          ✓
                        </span>
  ...
  meta: [
    {
      name: 'description',
      content:
        'A demo application for PKCE authentication with Zitadel and Qwik.',
    },
  ],
};
